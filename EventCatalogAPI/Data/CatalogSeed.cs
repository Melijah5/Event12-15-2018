    ...
    public class CatalogSeed
    {
        ...
        private static IEnumerable<Event> GetPreConfigeredEvents()
        {
            return new List<Event>()
            {
                ...
                //new Event() {EventCategoryId=6, EventSubCatagoryId=6,  Location= "CA" , EventName = "Programming", Description = "Detail about c#", EventStartDate = "1/4/2019", EventEndDate="9/19/2019", EventStartTime = "2pm", EventEndTime="7pm", UnitPrice= 950, Address= "Downtown Burbank , Burbank, CA",Created="10/12/2018", EventImageUrl= "http://externalcatalogbaseurltobereplaced/api/Pic/5" },
                ...
                // new Event() { EventCategoryId=2, EventSubCatagoryId=3, Location= "WA" , EventName = "Fresh Hop Dinner with Fremont Brewing Food & Drink",Description = "Chefs Bradley Layfield and Brendon Bain", EventStartDate = "2/4/2019", EventEndDate="2/4/2019", EventStartTime = "2pm", EventEndTime="7pm", UnitPrice= 40, Address= "310 Terry Ave N, Seattle, WA 98109 ",Created="10/12/2018", EventImageUrl= "http://externalcatalogbaseurltobereplaced/api/Pic/3" },
